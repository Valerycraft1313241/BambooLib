...
public enum Materials {
   ...
   public static void init() {
      Materials[] var0 = values();

       for (Materials var3 : var0) {
           if (var3.isPlaceholder() || var3.isNewPlaceholder()) {
               placeholderMaterials.add(var3);
           }

           materialCache.put(var3, var3.getItem().build());
       }
   ...
   public ItemBuilder getItem() {
      ...
      if (this.prepared != null) {
         ...
         case MAT:
            var1 = new ItemBuilder(this.prep.getMaterial());
            break;
         case ID:
            var1 = new ItemBuilder(this.prep.getId());
            break;
         case ID_DATA:
            var1 = new ItemBuilder(this.prep.getId(), this.prep.getData());
         }
   ...
   public static Materials getItemStackMaterial(ItemStack var0) {
      Materials[] var1 = values();

       for (Materials var4 : var1) {
           if (!placeholderMaterials.contains(var4)) {
               boolean var5;
               if (BambooUtils.isVersion(8, 12)) {
                   var5 = materialCache.get(var4).getType().getData() == var0.getType().getData();
               } else {
                   var5 = true;
               }

               if (var5 && materialCache.get(var4).getType().equals(var0.getType())) {
                   return var4;
               }
           }
       }
   ...
   public static Materials getBlockMaterial(Block var0) {
      ItemBuilder var1 = new ItemBuilder(var0.getType());
      if (BambooUtils.isVersion(8, 12)) {
         var1.setData(var0.getTypeId());
      }

      ItemStack var2 = var1.build();
      Materials[] var3 = values();

       for (Materials var6 : var3) {
           if (!placeholderMaterials.contains(var6)) {
               boolean var7;
               if (BambooUtils.isVersion(8, 12)) {
                   var7 = materialCache.get(var6).getType().getData() == var2.getType().getData();
               } else {
                   var7 = true;
               }

               if (var7 && materialCache.get(var6).getType().equals(var2.getType())) {
                   return var6;
               }
           }
       }
   ...
   public static Materials getBlockMaterial(World var0, int var1, int var2, int var3) {
      Block var4 = var0.getBlockAt(var1, var2, var3);
      ItemBuilder var5 = new ItemBuilder(var4.getType());
      if (BambooUtils.isVersion(8, 12)) {
         var5.setData(var4.getTypeId());
      }

      ItemStack var6 = var5.build();
      Materials[] var7 = values();

       for (Materials var10 : var7) {
           if (!placeholderMaterials.contains(var10)) {
               boolean var11;
               if (BambooUtils.isVersion(8, 12)) {
                   var11 = materialCache.get(var10).getData() == var6.getData();
               } else {
                   var11 = true;
               }

               if (var11 && materialCache.get(var10).getType().equals(var6.getType())) {
                   return var10;
               }
           }
       }
   ...
   Materials(MP var3, MP var4) {
      String var5 = VersionSupport.getInstance().getVersion();
      byte var6 = -1;
      switch(var5.hashCode()) {
      case -1497165255:
         if (var5.equals("v1_12_R1")) {
            var6 = 1;
         }
         break;
      case -1496986508:
         if (var5.equals("v1_18_R2")) {
            var6 = 2;
         }
         break;
      case -1496956718:
         if (var5.equals("v1_19_R1")) {
            var6 = 3;
         }
         break;
      case -1496956717:
         if (var5.equals("v1_19_R2")) {
            var6 = 4;
         }
         break;
      case -1156422964:
         if (var5.equals("v1_8_R3")) {
            var6 = 0;
         }
      }
   ...
   Materials(MP var3, MP var4, boolean var5, boolean var6) {
      String var7 = VersionSupport.getInstance().getVersion();
      byte var8 = -1;
      switch(var7.hashCode()) {
      case -1497165255:
         if (var7.equals("v1_12_R1")) {
            var8 = 1;
         }
         break;
      case -1496986508:
         if (var7.equals("v1_18_R2")) {
            var8 = 2;
         }
         break;
      case -1496956718:
         if (var7.equals("v1_19_R1")) {
            var8 = 3;
         }
         break;
      case -1496956717:
         if (var7.equals("v1_19_R2")) {
            var8 = 4;
         }
         break;
      case -1156422964:
         if (var7.equals("v1_8_R3")) {
            var8 = 0;
         }
      }
   ...
   Materials(MP var3) {
      String var4 = VersionSupport.getInstance().getVersion();
      byte var5 = -1;
      switch(var4.hashCode()) {
      case -1497165255:
         if (var4.equals("v1_12_R1")) {
            var5 = 1;
         }
         break;
      case -1496986508:
         if (var4.equals("v1_18_R2")) {
            var5 = 2;
         }
         break;
      case -1496956718:
         if (var4.equals("v1_19_R1")) {
            var5 = 3;
         }
         break;
      case -1496956717:
         if (var4.equals("v1_19_R2")) {
            var5 = 4;
         }
         break;
      case -1156422964:
         if (var4.equals("v1_8_R3")) {
            var5 = 0;
         }
      }
   ...
   Materials(Materials var3, boolean var4) {
      this.newPlaceholder = var4;
      String var5 = VersionSupport.getInstance().getVersion();
      byte var6 = -1;
      switch(var5.hashCode()) {
      case -1497165255:
   ...
   Materials(Materials var3, boolean var4, VersionSupport.VersionType var5) {
      this.newPlaceholder = var4;
      String var6 = VersionSupport.getInstance().getVersion();
      byte var7 = -1;
      switch(var6.hashCode()) {
      case -1497165255:
         if (var6.equals("v1_12_R1")) {
            var7 = 1;
         }
         break;
      case -1156422964:
         if (var6.equals("v1_8_R3")) {
            var7 = 0;
         }
      }
      ...
      case 1:
         ...
         break;
      default:
         if (VersionSupport.getInstance().getVersionType().getVersionID() < var5.getVersionID()) {
            this.prep = var3.prep;
         } else {
            this.prep = new MP(this.toString());
         }
   ...
   Materials(Materials var3, boolean var4, boolean var5) {
      this.newPlaceholder = var4;
      String var6 = VersionSupport.getInstance().getVersion();
      byte var7 = -1;
      switch(var6.hashCode()) {
      case -1497165255:
         ...
         break;
      case -1496986508:
         if (var6.equals("v1_18_R2")) {
            var7 = 2;
         }
         break;
      case -1496956718:
         if (var6.equals("v1_19_R1")) {
            var7 = 3;
         }
         break;
      case -1496956717:
         if (var6.equals("v1_19_R2")) {
            var7 = 4;
         }
         break;
      case -1156422964:
   ...
   Materials(Materials var3, boolean var4, String var5) {
      this.newPlaceholder = var4;
      String var6 = VersionSupport.getInstance().getVersion();
      byte var7 = -1;
      switch(var6.hashCode()) {
